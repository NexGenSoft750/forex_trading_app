...
import styles from './COTReportNetPositionComparisonChart.module.scss';
...
const COTReportNetPositionComparisonChart: React.FC = () => {
...
export default COTReportNetPositionComparisonChart;