...
import styles from './COTReportPositionChart.module.scss';
...
const COTReportPositionChart: React.FC<PositionChart> = ({ data, title }) => {
...
export default COTReportPositionChart;