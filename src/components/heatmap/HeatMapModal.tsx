...
const cell = (text: React.ReactNode, style?: React.CSSProperties) => (
  <td style={txt({
    padding: '10px 12px',
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            {cell("11", { background: "#f4f5f7", textAlign: "center", color: "black", fontWeight: 600 as const })}
                          ...
                          <tr>
                            {cell("Seasonality", { background: "#f4f5f7", fontWeight: 600, color: "black", border: '2px solid white' })}
                            {cell("-5", { background: "#f4f5f7", textAlign: "center", color: "black", fontWeight: 600 as const })}
                            {cell(<span style={txt({ fontWeight: 600, color: "black" })}>Bearish</span>, {
                              background: "#F4A6A6",
                              textAlign: "center" as const,
                            })}
                          ...
                          <tr>
                            {cell("Cot Score", { background: "#f4f5f7", fontWeight: 600, color: "black", border: '2px solid white' })}
                            {cell("-1", { background: "#f4f5f7", textAlign: "center", color: "black", fontWeight: 600 as const })}
                          ...
                          <tr>
                            {cell("C-Score", { background: "#f4f5f7", fontWeight: 600, color: "black", border: '2px solid white' })}
                            {cell("1", { background: "#f4f5f7", textAlign: "center", color: "black", fontWeight: 600 as const })}
                            {cell(<span style={txt({ fontWeight: 600 })}>Bullish</span>, {
                              background: "#B9F0BE",
                              textAlign: "center" as const,
                          ...
                          <tr>
                            {cell("T-Score", { background: "#f4f5f7", fontWeight: 600, color: "black", border: '2px solid white' })}
                            {cell("2", { background: "#f4f5f7", textAlign: "center", color: "black", fontWeight: 600 as const })}
                            {cell(<span style={txt({ fontWeight: 600 })}>Bullish</span>, {
                              background: "#B9F0BE",
                              textAlign: "center" as const,
                              color: "black",
                          ...
                          <tr>
                            {cell("Risk Meter", { background: "#f4f5f7", fontWeight: 600, color: "black", border: '2px solid white' })}
                            {cell("14", { background: "#f4f5f7", textAlign: "center", color: "black", fontWeight: 600 as const })}
                            {cell(<span style={txt({ fontWeight: 600, color: "black" })}>Risk On</span>, {
                              background: "#F4A6A6",
                              textAlign: "center" as const,
                            })}
                          </tr>
                        ...
                        <tbody>
                          {[
                            ...
                            <tr key={i} style={txt({ borderTop: '1px solid #eef3fb' })}>
                              ...
                              <td style={txt({ padding: '10px 12px', textAlign: 'right' as const })}>{r[1]}</td>
                              <td style={txt({ padding: '10px 12px', width: 120, color: i === 0 ? '#d35400' : '#c02a2a', fontWeight: 500 })}>{r[2]}</td>
                              <td style={txt({ padding: '10px 12px', textAlign: 'right' as const })}>{r[3]}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
