...
import RetailSentimentHorizontalBarChart from '@/components/retail-sentiment/tables/charts/RetailSentimentHorizontalBarChart';

export default function RetailSentimentPage() {
    return (
        <>
            <div>
                <div className={styles.retailSentimentContainer}>
