...
import SentimentOverview from '@/components/heatmap/SentimentOverview';
...
const FxAnalyzerProPage = () => {
    return (
        <>
            <div className={styles.fxAnalyzerPro__pageContainer}>
                <div className={styles.fxAnalyzerPro__dropdownSection}>
                    <Dropdown btnLabel='USD' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                    <Dropdown btnLabel='GBP' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                    <Dropdown btnLabel='EUR' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                    <Dropdown btnLabel='AUD' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                    <Dropdown btnLabel='CAD' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                    <Dropdown btnLabel='NZD' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                    <Dropdown btnLabel='CHF' menus={['USDCA', 'USDCHF', 'USDJPY']} />
                </div>
...
export default FxAnalyzerProPage;